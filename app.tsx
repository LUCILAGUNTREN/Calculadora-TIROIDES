...
import BethesdaCalculator from './components/BethesdaCalculator'
...
const App: React.FC = () => {
  ...
  const renderCalculator = () => {
    switch (activeCalculator) {
      case 'TIRADS': return <TiradsCalculator />
      case 'Bethesda': return <BethesdaCalculator />
      case 'TNM': return <TnmCalculator />
      case 'ATA Risk': return <AtaRiskCalculator />
      case 'Dynamic Risk': return <DynamicRiskCalculator />
      case 'RAI Dose': return <RaiDoseCalculator />
      case 'Levothyroxine': return <LevothyroxineCalculator />
      default: return <TiradsCalculator />
    }
  }
