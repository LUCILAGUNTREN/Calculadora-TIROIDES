...
const TiradsCalculator: React.FC = () => {
  ...
  const { score, tiradsLevel, recommendation, color } = useMemo(() => {
    ...
    if (totalScore === 0) {
      ...
      rec = 'Un puntaje de 1 no corresponde a una categoría TI-RADS (ACR 2017).'
  ...
  return (
    <Card title="Puntaje de Riesgo TI-RADS (ACR 2017)" description="Evalúe el riesgo de malignidad basado en características ecográficas.">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4">
        <SelectInput
          ...
          options={[
            { value: '0', label: 'Quístico/casi quístico o Espongiforme (0 ptos)' },
