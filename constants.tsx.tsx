...
export const CALCULATORS: { id: Calculator; name: string; icon: React.ReactElement }[] = [
  ...
  { id: 'RAI Dose', name: 'Dosis I-131', icon: <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M19.428 15.428a2 2 0 00-1.022-.547l-2.387-.477a6 6 0 00-3.86.517l-.318.158a6 6 0 01-3.86.517L6.05 15.21a2 2 0 00-1.806.547a2 2 0 00-.547 1.806l.477 2.387a6 6 0 00.517 3.86l.158.318a6 6 0 00.517 3.86l2.387.477a2 2 0 001.806-.547a2 2 0 00.547-1.806l-.477-2.387a6 6 0 01-.517-3.86l-.158-.318a6 6 0 01-.517-3.86l.477-2.387a2 2 0 01.547-1.806z" /><path strokeLinecap="round" strokeLinejoin="round" d="M14.243 5.757a2 2 0 00-1.022.547l-2.387.477a6 6 0 00-3.86-.517l-.318-.158a6 6 0 01-3.86-.517L.572 7.022a2 2 0 00-1.806.547a2 2 0 00-.547 1.806l.477 2.387a6 6 0 00.517 3.86l.158.318a6 6 0 00.517 3.86l2.387.477a2 2 0 001.806-.547a2 2 0 00.547-1.806l-.477-2.387a6 6 0 01-.517-3.86l-.158-.318a6 6 0 01-.517-3.86l.477-2.387a2 2 0 01.547-1.806z" /></svg> },
...
export const BETHESDA_DATA: { [key: string]: { name: string; risk: string; management: string; color: string } } = {
  'I': { name: 'I. No Diagnóstico o Insatisfactorio', risk: '1-4%', management: 'Repetir PAAF con guía ecográfica', color: 'bg-slate-50' },
  'II': { name: 'II. Benigno', risk: '0-3%', management: 'Seguimiento clínico', color: 'bg-green-50' },
  'III': { name: 'III. Atipia de Significado Indeterminado (AUS) o Lesión Folicular de Significado Indeterminado (FLUS)', risk: '5-15%', management: 'Repetir PAAF, pruebas moleculares o lobectomía diagnóstica', color: 'bg-yellow-50' },
  'IV': { name: 'IV. Neoplasia Folicular o Sospechoso de Neoplasia Folicular', risk: '15-30%', management: 'Lobectomía diagnóstica', color: 'bg-orange-50' },
  'V': { name: 'V. Sospechoso de Malignidad', risk: '60-75%', management: 'Tiroidectomía (casi) total o lobectomía', color: 'bg-red-50' },
  'VI': { name: 'VI. Maligno', risk: '97-99%', management: 'Tiroidectomía (casi) total', color: 'bg-red-50' },
}